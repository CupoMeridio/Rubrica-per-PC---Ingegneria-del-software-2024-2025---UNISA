 ...
 */
    ...
    private void actionLogin(ActionEvent event) {
        Database database = new Database();
          Database.connection = database.ConnectionDB();
        ...
        if(esito==0){
            ...
            try {
                ...
                AlertUtils.showError("Errore", "Si è verificato un errore durante il caricamento della schermata principale.");
            }
        }
        else{
